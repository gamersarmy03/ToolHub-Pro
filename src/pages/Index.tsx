    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">ToolHub Pro</h1>
            </div>
            <nav className="hidden md:flex gap-8">
              <button onClick={() => scrollToSection('pdf-tools')} className="hover:opacity-80 transition-opacity">PDF Tools</button>
              <button onClick={() => scrollToSection('image-tools')} className="hover:opacity-80 transition-opacity">Image Tools</button>
              <button onClick={() => scrollToSection('document-tools')} className="hover:opacity-80 transition-opacity">Document Tools</button>
      ...
      <main>
        ...
        <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16 text-center">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-5xl font-bold mb-4">All Your Document Tools in One Place</h2>
            <p className="text-xl mb-12 opacity-90">Process PDFs, images, and documents online - completely free and secure</p>
            <div className="flex justify-center gap-16 flex-wrap">
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">25+</div>
                <div className="opacity-90">Tools Available</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold mb-2">100%</div>
                <div className="opacity-90">Free to Use</div>
              </div>
              <div className="text-center">
        ...
        {/* PDF Tools */}
        <section id="pdf-tools" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <h3 className="text-4xl font-bold text-center mb-12 text-gray-800">PDF Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div 
                  ...
                  className="bg-white rounded-xl p-8 text-center shadow-md border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer hover:border-indigo-500"
                >
                  <div className="text-5xl mb-4">{tool.icon}</div>
                  <h4 className="text-xl font-semibold mb-2 text-gray-800">{tool.title}</h4>
        ...
        {/* Image Tools */}
        <section id="image-tools" className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <h3 className="text-4xl font-bold text-center mb-12 text-gray-800">Image Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
        ...
        {/* Document Tools */}
        <section id="document-tools" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <h3 className="text-4xl font-bold text-center mb-12 text-gray-800">Document Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
        ...
        {/* Upload Section */}
        {currentTool && (
          <section id="upload-area" className="py-16 bg-gray-50">
            <div className="max-w-4xl mx-auto px-4">
              <div className="bg-white rounded-xl border-2 border-dashed border-gray-300 p-12 text-center hover:border-indigo-500 hover:bg-gray-50 transition-all duration-300">
                <div className="text-6xl text-indigo-600 mb-6">📤</div>
                <h3 className="text-2xl font-bold mb-2 text-gray-800">{toolConfigs[currentTool]?.title}</h3>
                <p className="text-gray-600 mb-8">{toolConfigs[currentTool]?.description}</p>
                ...
                {selectedFiles.length > 0 && (
                  <div className="mt-8 text-left">
                    {selectedFiles.map((file) => (
                      <div key={file.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-lg mb-2">
                        <div>
                    ...
                    <Button 
                      ...
                      className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-3 mt-4"
                    >
                ...
                {showDownloads && (
                  <div className="mt-8">
                    <h4 className="text-xl font-semibold mb-4 text-gray-800">Download Processed Files:</h4>
        ...
        <section id="about" className="py-16 bg-white">
          <div className="max-w-6xl mx-auto px-4">
            <h3 className="text-4xl font-bold text-center mb-12 text-gray-800">Why Choose ToolHub Pro?</h3>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h4 className="text-xl font-semibold mb-4">ToolHub Pro</h4>
              <p className="text-gray-300">Your one-stop solution for document processing</p>
            </div>
            <div>
